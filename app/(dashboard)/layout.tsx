...
const navItems = [
  ...
  { href: '/facial-attendance', label: 'Facial DTR', icon: Camera },
        ...
        <header className="hidden lg:flex sticky top-0 z-30 items-center gap-4 px-8 py-4 bg-[#050914]/70 backdrop-blur-2xl border-b border-white/[0.07]">
          <div className="relative w-[380px]">
            ...
            <input
              ...
              className="w-full bg-white/[0.04] border border-white/10 rounded-xl pl-10 pr-4 py-2.5 text-sm text-slate-100 [color-scheme:dark] placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-cyan-400/40 focus:border-cyan-300/30 transition-all"
            />
          </div>
